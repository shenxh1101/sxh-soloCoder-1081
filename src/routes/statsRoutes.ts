...
router.get('/survey/:surveyId/compare-versions', statsController.compareVersions);
router.get('/survey/:surveyId/block-reasons', statsController.getBlockReasonDistribution);
